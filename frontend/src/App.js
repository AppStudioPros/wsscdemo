...
function Hero() {
  ...
  // Scene 2: PWA installation animation - simplified flow, slowed by 15%
  useEffect(() => {
    if (currentScene === 1) {
      setPwaStep(0);
      const steps = [
        { step: 1, delay: 575 },      // Show dialog
        { step: 2, delay: 4025 },     // Click add button (highlight)
        { step: 3, delay: 4600 },     // Show homescreen with app
      ];
      steps.forEach(s => {
